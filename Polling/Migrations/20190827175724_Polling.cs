...
{
    public partial class Polling : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_Ip_PollId",
                table: "Answers",
                columns: new[] { "Ip", "PollId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Polls_UserId_Title",
                table: "Polls",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_Title_PollId",
                table: "Questions",
                columns: new[] { "Title", "PollId" },
                unique: true);
        }
